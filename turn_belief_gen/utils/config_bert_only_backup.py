...
# Training Setting
parser.add_argument('-md','--model', help='model', required=False, default="TRADE_bert_gru_parallel")
...
parser.add_argument('-bsz','--batch', help='Batch_size', required=False, type=int, default=20)
parser.add_argument('-llfb','--load_local_finetune_bert', help='whether to load local finetuned bert', required=False, type=int, default=1)
parser.add_argument('-lbp','--local_bert_path', help='local bert path', required=False, type=str, default="./params_bert_finetune/pytorch_model.bin")
...
parser.add_argument('-gs','--genSample', help='Generate Sample', type=int, required=False, default=1)
...
# Model architecture
parser.add_argument('-gate','--use_gate', help='', required=False, default=0, type=int)
...
parser.add_argument('-hdd','--hidden', help='Hidden size', required=False, type=int, default=512)
